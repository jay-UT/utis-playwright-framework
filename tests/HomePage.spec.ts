...
//  const home =new HomePage(page);
 ...
 await test.step('Navigate to Henry Schein UK Medical URL', async () => {
 ...
 await test.step('Click the Henry Schein icon', async () => {
    await CommonMethods.safeClick(page, home.icon_xpath, 10000);
  });

 await test.step('Verify page navigates to Henry Schein home page', async () => {
...
await test.step('Verify the sign in button should be visible on the home page', async () => {
   ...
   await test.step('Click on sign-in submit button', async () => {
